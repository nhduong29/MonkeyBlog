 ...
 */
@Entity
@Table(name = "blog_comment", catalog = "monkeyblog")
public class BlogComment implements java.io.Serializable {
	...
	public BlogComment(BlogCommentId id, BlogPost blogPost, BlogUser blogUser, int isReplyToId, String comment,
			boolean enabled) {
		this.id = id;
	...
	public BlogComment(BlogCommentId id, BlogPost blogPost, BlogUser blogUser, int isReplyToId, String comment,
			Boolean markRead, boolean enabled, Date date) {
		this.id = id;
		this.blogPost = blogPost;
		this.blogUser = blogUser;
		this.isReplyToId = isReplyToId;
